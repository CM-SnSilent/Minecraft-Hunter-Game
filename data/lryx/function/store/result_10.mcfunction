...
execute as @a[tag=team.2,tag=track.7,scores={s.death=0},limit=1,sort=arbitrary,nbt={Dimension:"minecraft:overworld"}] run title @a[tag=team.1,tag=track.7] actionbar [{"translate":"\u00a7a维度：\u00a7c主世界 \u00a7a目标："},{"selector":"@s"}]
execute as @a[tag=team.2,tag=track.7,scores={s.death=0},limit=1,sort=arbitrary,nbt={Dimension:"minecraft:the_nether"}] run title @a[tag=team.1,tag=track.7] actionbar [{"translate":"\u00a7a维度：\u00a7c地狱 \u00a7a目标："},{"selector":"@s"}]
execute as @a[tag=team.2,tag=track.7,scores={s.death=0},limit=1,sort=arbitrary,nbt={Dimension:"minecraft:the_end"}] run title @a[tag=team.1,tag=track.7] actionbar [{"translate":"\u00a7a维度：\u00a7c末地 \u00a7a目标："},{"selector":"@s"}]
...
execute as @a[tag=team.2,tag=track.8,scores={s.death=0},limit=1,sort=arbitrary,nbt={Dimension:"minecraft:overworld"}] run title @a[tag=team.1,tag=track.8] actionbar [{"translate":"\u00a7a维度：\u00a7c主世界 \u00a7a目标："},{"selector":"@s"}]
execute as @a[tag=team.2,tag=track.8,scores={s.death=0},limit=1,sort=arbitrary,nbt={Dimension:"minecraft:the_nether"}] run title @a[tag=team.1,tag=track.8] actionbar [{"translate":"\u00a7a维度：\u00a7c地狱 \u00a7a目标："},{"selector":"@s"}]
execute as @a[tag=team.2,tag=track.8,scores={s.death=0},limit=1,sort=arbitrary,nbt={Dimension:"minecraft:the_end"}] run title @a[tag=team.1,tag=track.8] actionbar [{"translate":"\u00a7a维度：\u00a7c末地 \u00a7a目标："},{"selector":"@s"}]
...
execute as @a[tag=team.2,tag=track.9,scores={s.death=0},limit=1,sort=arbitrary,nbt={Dimension:"minecraft:overworld"}] run title @a[tag=team.1,tag=track.9] actionbar [{"translate":"\u00a7a维度：\u00a7c主世界 \u00a7a目标："},{"selector":"@s"}]
execute as @a[tag=team.2,tag=track.9,scores={s.death=0},limit=1,sort=arbitrary,nbt={Dimension:"minecraft:the_nether"}] run title @a[tag=team.1,tag=track.9] actionbar [{"translate":"\u00a7a维度：\u00a7c地狱 \u00a7a目标："},{"selector":"@s"}]
execute as @a[tag=team.2,tag=track.9,scores={s.death=0},limit=1,sort=arbitrary,nbt={Dimension:"minecraft:the_end"}] run title @a[tag=team.1,tag=track.9] actionbar [{"translate":"\u00a7a维度：\u00a7c末地 \u00a7a目标："},{"selector":"@s"}]
...
execute as @a[tag=team.2,tag=track.10,scores={s.death=0},limit=1,sort=arbitrary,nbt={Dimension:"minecraft:overworld"}] run title @a[tag=team.1,tag=track.10] actionbar [{"translate":"\u00a7a维度：\u00a7c主世界 \u00a7a目标："},{"selector":"@s"}]
execute as @a[tag=team.2,tag=track.10,scores={s.death=0},limit=1,sort=arbitrary,nbt={Dimension:"minecraft:the_nether"}] run title @a[tag=team.1,tag=track.10] actionbar [{"translate":"\u00a7a维度：\u00a7c地狱 \u00a7a目标："},{"selector":"@s"}]
execute as @a[tag=team.2,tag=track.10,scores={s.death=0},limit=1,sort=arbitrary,nbt={Dimension:"minecraft:the_end"}] run title @a[tag=team.1,tag=track.10] actionbar [{"translate":"\u00a7a维度：\u00a7c末地 \u00a7a目标："},{"selector":"@s"}]