...
execute if score play.n lw.runner matches 11.. run function lryx:load
execute if entity @a[tag=spect] unless entity @a[tag=team.1] run function lryx:load
execute if entity @a[tag=spect] unless entity @a[tag=team.2] run function lryx:load
execute if entity @a[tag=team.2] unless entity @a[tag=team.1] run function lryx:load
execute if entity @a[tag=team.1] unless entity @a[tag=team.2] run function lryx:load
execute if entity @a[scores={n.change=1}] if entity @a[tag=track.3] run function lryx:load
